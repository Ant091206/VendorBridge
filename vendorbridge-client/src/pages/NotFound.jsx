    ...
    <div className="flex h-screen w-screen items-center justify-center bg-slate-950 text-slate-100">
      <div className="text-center max-w-md px-8">
        ...
        <div className="flex items-center justify-center gap-3 mb-10">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400 to-indigo-600 shadow-lg shadow-indigo-500/25">
        ...
        {/* 404 display */}
        <div className="text-8xl font-black text-indigo-500/30 leading-none mb-4">404</div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            to="/dashboard"
            className="rounded-lg bg-indigo-600 hover:bg-indigo-500 px-6 py-2.5 text-sm font-semibold text-white transition shadow-md shadow-indigo-600/20"
          >
            ← Back to Dashboard
          </Link>
          <button
